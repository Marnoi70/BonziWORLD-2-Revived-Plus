...
function errorFatal() {
    ("none" != $("#page_ban").css("display") && "none" != $("#page_kick").css("display")) || $("#page_error").show();
      ...
      function setup() {
        ...
        socket.on("video_autores", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.video_autores(a.vid);
        }),
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            this.$container.append("\n\t\t\t<div id='bonzi_" + this.id + "' class='bonzi'>\n\t\t\t\t<div class='bonzi_name'></div>\n\t\t\t\t\t" + e + "\n\t\t\t\t<p style='display:none'></p>\n\t\t\t</div>\n\t\t"),
                ...
                BonziHandler.sprites.push(this.color)
            ...
            (this.x = f.x * this.rng()),
                        ...
                        return {
                            items: {
                                ...
                                quote: {
                                    ...
                                    callback: function() {
                                        if(!d.last){
                                            alert("This person hasn't speaked yet.")
                                            return;
                                        }
                ...
                (this.needsUpdate = !1),
                this.runSingleEvent([{ type: "anim", anim: "surf_intro", ticks: 30 }]); var pol = new Audio("/assets/sfx/join.mp3"); pol.play();
        }
        return (
            _createClass(a, [
                {
                ...
                },
                {
                    key: "exit",
                    value: function (a) {
                        this.runSingleEvent([{ type: "anim", anim: "surf_away", ticks: 30 }]), setTimeout(a, 2e3); var pol = new Audio("/assets/sfx/bye.mp3"); pol.play();
                    },
                },
                {
                    key: "deconstruct",
                        ...
                        if (!this.mute) {
                            ...
                            this.$dialog
                                ...
                                .html(
                                    "\n\t\t\t\t\t<" +
                                        b +
                                        ' type="text/html" allow="autoplay" width="480" height="270" \n\t\t\t\t\tsrc="https://www.youtube.com/embed/' +
                                        a +
                ...
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            ...
                            this.$dialog
                                .addClass("bubble_autowidth")
                                .html(" <video loop autoplay controls id='bonziworld-video'><source src='" + a + "' type='video/mp4' loop>Your browser does not support the video tag.</video> "), this.$dialog.show();
                        }
                    },
                },
                {
                ...
                },
            {
                ...
                },
                {
                    key: "asshole",
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hé, " + a + "!" }, { type: "text", text: "Tu es un putain de connard!", say: "tu es un putain de connard!" }, { type: "anim", anim: "grin_fwd", ticks: 15 }, { type: "idle" }]);
                    },
                },
                {
                    key: "owo",
...
$(document).ready(function () {
    window.BonziHandler = new (function () {
        return (
            ...
            (this.spriteSheets = {}),
            (this.sprites = ["black", "blue", "brown", "diamond", "emerald", "gold", "green", "magenta", "orange", "pink", "purple", "red", "yellow", "pope",  "popehat", "hammer", "notpope", "walter", "einstein", "luther", "danieltard69", "danieltard692", "unbojih", "zander","characpurple","characblue","characgreen","characred","characblack","characbrown","geri","whitty","itssatireandnotintendedtobeoffensivestopcrying", "danielclown52","danielclown521","attl","allifek","bee","beggar","bgd","blur","bonziban","c_on","catgamer1","catgamer1new","chilly","chocolate","clippy","clippydioga","coffee","creeper","cyan","dark","darkgreen","darkspooky","david","deepfried","diamond","dioga","diogo","djordje","emerald","flippeddown","frostedglass","frosty","glass","glitch","glitch2","glitch3","glow","granddad","gd","inverted","invisible","iron","jpg","kernel","konnor","lapis","light","light2","mari0","mario","mem","nostalgic","nosurf","offcat","omegadioga","orange","owner","pixelated","pmgreen","pmyellow","pope2","pope3","pope4","pope5","pope6","pope7","pope8","pope9","pope10","god","god2","god3","god4","god5","greenio","ics","garfield","power","power2","power3","power4","power5","prody","program","purple2","purplebonzi","purplesaber","qmark","qmarkpope","quartz","rainbow","red","reddog","redst","relief","rover","sepia","shake","skinny","soldier","spooky","spooky3","stockman","thick","white","whitelight","yclippy","yellow","acid","nodaniel","seamus"]),
            ...
            (this.speak = function (a, b, c, d) {
                var e = { samples_queue: [] };
                espeak.setVoice.apply(espeak, ["default", "fr"]),
